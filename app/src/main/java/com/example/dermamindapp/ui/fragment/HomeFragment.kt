...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Navigation for Main Scan Button
        scanButton.setOnClickListener {
            // **PERBAIKAN DI SINI**
            // Gunakan NavController dari Activity untuk navigasi antar graph
            requireActivity().findNavController(R.id.nav_host_fragment).navigate(R.id.action_mainFragment_to_cameraFragment)
        }

        // Data and Navigation for Articles Feature
        articles = listOf(
    ...
    private fun loadLastAnalysis() {
        ...
        if (lastAnalysis != null) {
            // Show analysis card if history exists
